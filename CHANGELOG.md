...
### Added
- README hero/inbox/palette/themes screenshots — npm package page now shows
  the component in action (sourced from raw URLs in /media of the GitHub repo,
  not bundled in the npm tarball).
